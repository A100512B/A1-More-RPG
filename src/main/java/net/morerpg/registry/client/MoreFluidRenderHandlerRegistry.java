...
public class MoreFluidRenderHandlerRegistry {
    ...
    public static final FluidRenderHandler BLAZING_BLOOD_RENDER_HANDLER
            = SimpleFluidRenderHandler.coloredWater(BLAZING_BLOOD_TINT);

    public static void register() {
        FluidRenderHandlerRegistry.INSTANCE.register(BLAZING_BLOOD_STILL, BLAZING_BLOOD_FLOWING, BLAZING_BLOOD_RENDER_HANDLER);
